...
function displaySection(repoName, index, repoDesc) {
    ...
    if(index == 0) {
        ...
        html += '<section class="two"><h1 class="dark"><a style="color: #87b2a4 !important; text-align: center;" class="underline" target="_blank" href="https://github.com/esther588/' + repoName + '">' + repoName + '</a><br>' + repoDesc + '<br></h1></section>';
    } else if(index == 2) {
